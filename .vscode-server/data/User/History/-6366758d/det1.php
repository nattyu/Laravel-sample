        ...
        <form method="post" action="">
            ...
            @foreach ($postAttendance as $p_attendance)
                <div class="mt-8">
                    ...
                    <select type="text" class="form-control" name="attend_flg[]" required class="w-4">
                        <option disabled style='display:none;'  @if ($p_attendance->attend_flg == "-") selected @endif>-</option>
