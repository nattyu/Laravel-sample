                ...
                <div class="w-full flex flex-col">
                    ...
                    <select type="text" class="form-control" name="court_id" required>
                        ...
                        @foreach($registed_courts as $r_court)
                            <option value="{{ old('court_id', $postCourt->court_id) }}" @if (isset($r_court->court_id) && ($r_court->court_id === $postCourt->court_id)) selected @endif>{{ old('court_name', $postCourt->court_name) }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <select type="text" class="form-control" name="start_time" required>
                        ...
                        @foreach($start_times as $s_time)
                            <option value="{{ old('start_time', $postCourt->start_time) }}">{{ $s_time }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <select type="text" class="form-control" name="end_time" required>
                        ...
                        @foreach($end_times as $e_time)
                            <option value="{{ old('end_time', $postCourt->end_time) }}">{{ $e_time }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
