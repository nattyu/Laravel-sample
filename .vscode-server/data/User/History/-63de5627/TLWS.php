                ...
                <div class="w-full flex flex-col">
                    ...
                    <select type="text" class="form-control" name="start_time" required>
                        ...
                        @foreach($start_times as $s_time)
                            <option value="{{ old('start_time', $postCourt->start_time) }}">{{ old('start_time', $postCourt->start_time) }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <select type="text" class="form-control" name="end_time" required>
                        ...
                        @foreach($end_times as $e_time)
                            <option value="{{ old('end_time', $postCourt->end_time) }}">{{ old('end_time', $postCourt->end_time) }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
