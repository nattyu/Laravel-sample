        ...
        <form method="post" action="{{ route('post-court.update', $postCourt) }}">
            ...
            <div class="">
                <div class="w-full sm:flex sm:flex-col">
                    ...
                    <input type="date" class="form-control w-auto py-2" id="elected_date" name="elected_date" value="{{ old('elected_date', $postCourt->elected_date) }}">
                </div>
            </div>
            ...
            <div class="">
                <div class="w-full sm:flex sm:flex-col">
                    ...
                    <select type="text" class="form-control w-auto py-2" name="court_id" required>
            ...
            <div class="">
                <div class="w-full sm:flex sm:flex-col">
                    ...
                    <select type="text" class="form-control w-auto py-2" name="start_time" required>
            ...
            <div class="">
                <div class="w-full sm:flex sm:flex-col">
                    ...
                    <select type="text" class="form-control w-auto py-2" name="end_time" required>
