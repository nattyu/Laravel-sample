                ...
                <div class="w-full flex flex-col">
                    ...
                    <select type="text" class="form-control" name="court_select" required>
                        ...
                        @foreach($registed_courts as $r_court)
                            <option value="{{ $r_court->id }}" @if (isset($r_court->court_id) && ($r_court->court_id === $postCourt->id)) selected @endif>{{ $r_court->court_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <select type="text" class="form-control" name="start_time" required>
                        ...
                        @foreach($start_times as $s_time)
                            <option value="{{ $s_time }}" @if (isset($s_time) && ($s_time == $postCourt->start_time)) selected @endif>{{ $s_time }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <select type="text" class="form-control" name="end_time" required>
                        ...
                        @foreach($end_times as $e_time)
                            <option value="{{ $e_time }}" @if (isset($e_time) && ($e_time == $postCourt->end_time)) selected @endif>{{ $e_time }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
